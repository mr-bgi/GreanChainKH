...
//Search
const search = document.getElementById("minify");
const searchBar = document.querySelector("#s-bar");
const back = document.getElementById("cross");
search.addEventListener("click", function () {
    searchBar.style.transform = "translateY(100px)";
    searchBar.style.opacity = "1";
});
back.addEventListener("click", function () {
    searchBar.style.transform = "translateY(-250px)";
